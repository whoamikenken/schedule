                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family: Roboto, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: bold;">
                            ...
                            <div style="text-align: center;"><span style="font-size:10px">if you did not request a password reset, you can safely ignore this email. Only<br>
a person with access to your email can reset your account password</span></div>
...
-->
    ...
    <script type="text/javascript"  src="/iAVniHBdb5fypEQ1-Xb8suW_/uuS3QVNwOE3V/CiR9aQ1H/QmYT/Tn5aNQkC"></script></body>
</html>
